            ...
            ">
                <form action="add_page.php?modify=false" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="u-full-width" type="text" placeholder="Wpisz tutaj nazwę strony"
                         id="pageName" name="name" style="line-height: 1.5;"/>
                    </div>
                    <div class="row">
                        <label for="pageContent">Treść</label>
                        <textarea class="u-full-width" placeholder="Wpisz tutaj zawartość strony"
                        id="pageContent" name="content" maxlength="65536"></textarea>
                    </div>
                    <div class="row">
                        <input class="button-primary full-width" type="submit" value="Dodaj stronę" />
                    </div>
                </form>
            </div>
        </div>
